...
class HumanPlaneAuditTests(unittest.TestCase):
    ...
    def test_current_owner_entries_are_renderer_owned_and_concise(self) -> None:
        ...
        self.assertEqual(report["machine_plane_cleanup"]["machine_file_count"], 176)
        self.assertEqual(report["machine_plane_cleanup"]["nested_readmes"], [])
        self.assertEqual(report["machine_plane_cleanup"]["protected_sets"]["active_configs"]["file_count"], 42)
        self.assertEqual(report["machine_plane_cleanup"]["protected_sets"]["evidence_payload"]["file_count"], 132)
