...
D={}
D["cognitive-os.md"]=f"""# 认知操作系统 · William Harvey
...
"""
D["decision-policy.md"]=f"""# 决断规则 · William Harvey
...
"""
D["strategy.md"]=f"""# 策略 · William Harvey
...
{B([fa[2],fa[3],mm[3]])}
"""
D["capabilities.md"]=f"""# 能力 · William Harvey
...
{B([fa[15],bo[0],bo[1]])}
"""
D["work.md"]=f"""# 工作方式 · William Harvey
...
{B([fa[18]])}
"""
D["persona.md"]=f"""# 人格 · William Harvey
...
{B([bo[1],bl[0]])}
"""
D["boundaries.md"]=f"""# 边界 · William Harvey
...
{B(bl)}
"""
D["divergence-map.md"]=f"""# 分歧图谱 · William Harvey
...
{B([bl[1]])}
"""
D["facts.md"]=f"""# 事实底册 · William Harvey
...
{B(fa[20:])}
"""
D["hypotheses.md"]=f"""# 假说 · William Harvey
