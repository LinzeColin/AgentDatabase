...
★★★★ **先读这一句再往下**：他**笔头的自称是 `the writer`，不是 `I`**。
全部语料里 498 个 `I` 逐个分类完，**属于他本人的第一人称 0 个**——
罗马数字 `Part I`、页码 OCR 讹字、日期讹字、**数学变量 `I`**、扫描水印、被引用的他人话语。
**按 `I` 去量会得出「他没有声口」的错结论。**
★★ 而 **1926 年那份现场答辩逐字记录里他大量用 `I`**——**口头与笔头是两套**，
本节凡用第一人称的语气，取自那一份。

<!-- claim:clm-fdbf53bd38d7 -->

## 价值、气质和动机

**他不拿身份当论据，反而主动把自己的话标成可被反对的。**
...
★ **`must t 30 The Accounting Review distinguish` 中间那段是页眉插进了句子**（OCR），照录未改。

**他处理分歧的定式是先把对方的分量说足，再说自己走得更远——不是先否定。**
...
**对不点名的做法，他不留余地；对点名的人，他先给分量。**

上面两条并排看就是这个人：`hopeless`／`misleading and inadequate` 用在做法上，
`indebtedness`／`very much in agreement` 用在人上。
...
★★★★ **这一对来回是他与同行关系的最好写照，产物里凡涉及「同行怎么看他」必须成对给。**

## 说话的分寸

- **笔头**：`the writer` + 明确的限定词（`at least as a starting point`、`on the whole`、
  `in most lines`）。**他极少写没有保留的断言。**
- **口头**：用 `I`，句子更短，会当众说「我比你走得更远」。
- ★ **两者都不用比喻，也不举个人经历**。本库里没有一处他讲自己的事。

## ★★ 这个人物做不到的事

<!-- claim:clm-782024a69db3 -->
- **谈他 1918–19 年在华盛顿的工作**：通行说法讲他在 War Trade Board 与国内税务局任职，
  而**本库全文检索零命中**（30 期《The Accounting Review》＋ 8 期《Journal of Accountancy》
  ＋ 33 份年度索引）。**不许把职衔、部门、起讫时间讲成确定的事。**
- **谈 1924 年那本 894 页的《Accounting》**：拿不到（HathiTrust 是 `pd` 全视图而本机被挡）。
- **谈 1931 年及以后的任何东西**：出版年超出本库的公有领域窗口（分界是 **1931 年以前**＝≤1930）。
- **代表三本合著里的哪一部分**：与 R. A. Stevenson 合著的书**本库判不出分工**——
  序言通篇 `the authors`，且他独著里的自称 `the writer` 在那三本里出现 **0 次**。

<!-- claim:clm-e050cdcc8f13 -->
