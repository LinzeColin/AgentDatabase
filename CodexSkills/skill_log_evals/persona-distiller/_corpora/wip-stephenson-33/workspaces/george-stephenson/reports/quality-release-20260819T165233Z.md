...
- Phase: `release`
- Profile: `quick`
- Generated: `2026-08-19T16:52:33Z`
- Result: **FAIL**
...
```json
{
  ...
  "content_review": {
    ...
    "answer_surface_leak": "✓ 总体均长比 1.07（门 ≤1.3）　候选更短 9/32 = 28%（门 ≥25%）；表面特征最高 表面特征（定向可利用率，门 ≤75%）：",
  ...
  "activation_yield": {
    ...
    "输出": [
      ...
      "   substantive_lines: 103",
      "   bookkeeping_lines: 6",
      "   payload_lines: 97",
      "   bookkeeping_ratio: 0.0583",
      "   payload_ratio: 0.9417"
    ]
  },
  "anchor_coherence": {
    "退出码": 0,
  ...
  "eval_results": 64,
  "candidate_overall": 0.8525,
  "baseline_overall": 0.7094,
  "candidate_baseline_delta": 0.1431,
...
- `content.unsourced-name`: 答案里有查无实据的人名——✗ **无依据 4 个**——全名与姓氏在语料、排除记录里都查不到：
