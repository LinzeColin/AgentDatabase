# Justus von Liebig 人物 Skill

- 构建器：Persona Distiller `v0.0.0.5`
- 目录/Skill 名：`justus-von-liebig`
- 构建主身份：农林牧渔师
- 主身份规范值：`agriculture-fishery`
- 主场景：未指定；每次任务自动推断
- 来源类型：`historical`
- 研究档位：`deep`
- 内部模型快照：`0.1.0-draft`
- 人物产物版本：打包并成功登记时按该人物独立分配 `0.0.0.1` 至 `0.0.0.999`
- 创建时间：2026-08-04T10:18:29Z
...
默认安装到 `~/.codex/skills/justus-von-liebig`。研究工作区包含原始/受限材料；发布 ZIP 默认只带运行所需模型、审计摘要和安全更新模板。
