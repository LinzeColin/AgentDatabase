...
- Phase: `research`
- Profile: `quick`
- Generated: `2026-08-06T22:22:38Z`
- Result: **FAIL**
...
```json
{
  ...
  "attribution_basis": {
    ...
    "authority": "印刷时代人物，署名证据在扉页与落款上直接可读，不需要作者自著目录一类的外部权威。本人物的认定依据是 **Library of Congress Name Aut",
    "citation": "https://id.loc.gov/authorities/names/n85283138 （LC Name Authority，授权标目）；同名者权威源：W",
    "争议篇目数": 5,
    "P1 声称本人所著": 6,
    "未挂 attribution": 0
  },
  ...
  "content_review": {
    "byline_in_carrier": "核过 0 条，指错 0 条，**没核 9 条（不是通过）**",
