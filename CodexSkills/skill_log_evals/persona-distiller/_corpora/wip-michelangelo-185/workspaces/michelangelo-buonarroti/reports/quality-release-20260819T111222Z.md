...
- Phase: `release`
- Profile: `quick`
- Generated: `2026-08-19T11:12:22Z`
- Result: **FAIL**
...
```json
{
  ...
  "evidence_per_claim": {
    "断言条数": 26,
    "source_ids": "逐条各异（非空 26/26，不同取值 17）",
    "evidence_clusters": "逐条各异（非空 26/26，不同取值 19）",
    "counter_source_ids": "整批都空（非空 0/26，不同取值 0）"
  },
  ...
  "claim_coverage_checked": "实际检查 25/26 条（其中按引文判据 0 条；语料元断言 0、无实体无引文 1 未纳入）",
  "baseline_provenance": {
    "baseline_rows": 32,
    "by_source": {
      "unknown": 32
...
- `ledger.invalid`: clm-mc-mm-01 has invalid status
- `ledger.invalid`: clm-mc-he-01 has invalid status
- `ledger.invalid`: clm-mc-he-02 has invalid status
- `ledger.invalid`: clm-mc-he-03 has invalid status
...
- `claim.model-minimum`: mental models 1 < 2
- `claim.heuristic-minimum`: heuristics 0 < 3
- `claim.insufficient-contexts`: clm-504ac43c44d3 needs at least two materially different contexts
- `claim.insufficient-support`: clm-mc-mm-01 needs at least two supporting sources
- `claim.insufficient-contexts`: clm-mc-mm-01 needs at least two materially different contexts
- `claim.non-independent`: clm-mc-mm-01 needs at least two independent evidence clusters
- `claim.insufficient-support`: clm-mc-he-01 needs at least two supporting sources
- `claim.insufficient-contexts`: clm-mc-he-01 needs at least two materially different contexts
- `claim.non-independent`: clm-mc-he-01 needs at least two independent evidence clusters
- `claim.insufficient-support`: clm-mc-he-02 needs at least two supporting sources
- `claim.insufficient-contexts`: clm-mc-he-02 needs at least two materially different contexts
- `claim.non-independent`: clm-mc-he-02 needs at least two independent evidence clusters
- `claim.insufficient-support`: clm-mc-he-03 needs at least two supporting sources
- `claim.insufficient-contexts`: clm-mc-he-03 needs at least two materially different contexts
- `claim.non-independent`: clm-mc-he-03 needs at least two independent evidence clusters
- `claim.orphan`: active Claim clm-mc-mm-01 is not rendered in any core artifact
- `claim.orphan`: active Claim clm-mc-he-01 is not rendered in any core artifact
- `claim.orphan`: active Claim clm-mc-he-02 is not rendered in any core artifact
- `claim.orphan`: active Claim clm-mc-he-03 is not rendered in any core artifact
- `content.quote-no-locator`: 有逐字引文无从回查：同段内既无年份也无卷页刊名。长逐字引文 66 条，同段带坐标 63 条，**缺坐标 3 条**
...
- `claim.no-time-scope`: clm-mc-mm-01 lacks time scope
- `claim.no-time-scope`: clm-mc-he-01 lacks time scope
- `claim.no-time-scope`: clm-mc-he-02 lacks time scope
- `claim.no-time-scope`: clm-mc-he-03 lacks time scope
