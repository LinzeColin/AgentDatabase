...
- Phase: `release`
- Profile: `quick`
- Generated: `2026-08-19T10:52:22Z`
- Result: **FAIL**
...
```json
{
  ...
  "authorship": {
    "P1 声称为本人所著": 37,
    "已证实归属": 12,
    "**historical 路**：A-* 五种证据结构上不存在，归属改由 attribution_basis 认定": "25 条无 A-* 证据，**已按已声明的归属依据放行**（依据本身由 check_attribution_basis 硬拦）"
  },
  "corpus_integrity": {
    "已扫": 56,
    "不是语料": 0,
  ...
  "evidence_per_claim": {
    "断言条数": 22,
    "source_ids": "逐条各异（非空 22/22，不同取值 9）",
    "evidence_clusters": "逐条各异（非空 22/22，不同取值 10）",
  ...
  "claim_coverage_checked": "实际检查 21/22 条（其中按引文判据 0 条；语料元断言 0、无实体无引文 1 未纳入）",
  "baseline_provenance": {
    "baseline_rows": 32,
    "by_source": {
      "unknown": 32
...
- `claim.insufficient-support`: clm-504ac43c44d3 needs at least two supporting sources
- `claim.insufficient-contexts`: clm-504ac43c44d3 needs at least two materially different contexts
- `claim.non-independent`: clm-504ac43c44d3 needs at least two independent evidence clusters
- `claim.insufficient-support`: clm-57132310d198 needs at least two supporting sources
- `claim.non-independent`: clm-57132310d198 needs at least two independent evidence clusters
- `claim.insufficient-support`: clm-584dece9bffe needs at least two supporting sources
- `claim.non-independent`: clm-584dece9bffe needs at least two independent evidence clusters
- `claim.insufficient-support`: clm-f7a2ee35980a needs at least two supporting sources
- `claim.non-independent`: clm-f7a2ee35980a needs at least two independent evidence clusters
- `claim.insufficient-support`: clm-f7f67f29f5af needs at least two supporting sources
- `claim.non-independent`: clm-f7f67f29f5af needs at least two independent evidence clusters
- `claim.insufficient-support`: clm-a928f1063ac7 needs at least two supporting sources
- `claim.non-independent`: clm-a928f1063ac7 needs at least two independent evidence clusters
- `claim.insufficient-support`: clm-7cee3cb6b511 needs at least two supporting sources
- `claim.non-independent`: clm-7cee3cb6b511 needs at least two independent evidence clusters
- `claim.insufficient-support`: clm-2a3b37136bc9 needs at least two supporting sources
- `claim.non-independent`: clm-2a3b37136bc9 needs at least two independent evidence clusters
