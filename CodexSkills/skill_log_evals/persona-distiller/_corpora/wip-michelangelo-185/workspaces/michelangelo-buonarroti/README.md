# Michelangelo Buonarroti 人物 Skill

- 构建器：Persona Distiller `v0.0.0.5`
- 目录/Skill 名：`michelangelo-buonarroti`
- 构建主身份：艺术设计师
- 主身份规范值：`art-designer`
- 主场景：未指定；每次任务自动推断
- 来源类型：`historical`
...
默认安装到 `~/.codex/skills/michelangelo-buonarroti`。研究工作区包含原始/受限材料；发布 ZIP 默认只带运行所需模型、审计摘要和安全更新模板。
