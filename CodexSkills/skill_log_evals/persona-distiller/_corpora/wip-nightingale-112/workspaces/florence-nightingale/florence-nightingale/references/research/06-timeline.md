...
> 12 份，**S1 4 / S2 8——这条道上没有一份是她自己的话**。
> 她的生平细节只能标为二手，与 Fleming #111 的处境相同。
...
本人物讣告在 **BMJ 1910 vol.2 pp.437-9**；
而 **Florence Nightingale Boyd, M.D.** 的讣告在**同刊 1910 vol.1 pp.1582-3**。
**同年、同刊、同名——只有卷次能分。**
（全部四类同名排除见 `raw/_EXCLUDED.txt` 与 `meta.json` 的 `attribution_basis.exclusions`。）
...
**年份与事件序列**：可以，但要说明依据是传记而非自述。
**她某天在想什么、说了什么**：**不能**——那需要 `02-conversations.md`，
而那条道全是身后编集，没有一份原始定稿。
