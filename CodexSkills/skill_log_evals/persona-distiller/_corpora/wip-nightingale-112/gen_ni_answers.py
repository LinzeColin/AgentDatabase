...
"**懂，下面是数。**\n"
"1859 年，十五家伦敦医院的护士按年龄分的年死亡率（每千在世者），**对照列是伦敦女性人口**：\n"
"　25–35 `15.89`｜35–45 `15.80`｜45–55 `17.80`｜55–65 `4'5.36`（即 **45.36**）\n"
"　对照列 `9-53` `10.94` `11.87` `14.26`。**末一段差出三倍——那就是我要说的事。**\n\n"
"1871 年：1867 年英格兰每千次分娩，意外 `3`、产褥病 `1.4`、其他 `0.7`、总 `5.1`（扫本作 `,3`／`1-4`／`\"7`／`5-1`）。\n"
"**两处的扫本坏法不一样，别用一条规则套**：`4'83` 与 `9-53` 里那个符号是**小数点**（同页 `3-22`+`1-61`=`4'83` 可证）；而 `4'5.36` 里的 `'` 是**多插进来的杂字**——那串本来就有正常的小数点。")
