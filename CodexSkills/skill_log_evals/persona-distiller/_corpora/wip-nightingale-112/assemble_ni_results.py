...
KEY = json.loads((pathlib.Path("round1") / "ni_blind_key.json").read_text(encoding="utf-8"))
...
for seat, fn in (("seat-D-score-v1", "ni_judge_D.json"), ("seat-E-strict-v1", "ni_judge_E.json")):
    f = SP / fn
