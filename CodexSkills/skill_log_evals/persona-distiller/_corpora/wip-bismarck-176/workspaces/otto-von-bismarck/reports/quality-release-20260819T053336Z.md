...
- Phase: `release`
- Profile: `quick`
- Generated: `2026-08-19T05:33:36Z`
- Result: **FAIL**
...
```json
{
  ...
  "authorship": {
    "P1 声称为本人所著": 46,
    "已证实归属": 14,
    "**historical 路**：A-* 五种证据结构上不存在，归属改由 attribution_basis 认定": "32 条无 A-* 证据，**已按已声明的归属依据放行**（依据本身由 check_attribution_basis 硬拦）"
  },
  "corpus_integrity": {
    "已扫": 70,
    "不是语料": 0,
  ...
  "content_review": {
    ...
    "ocr_language_death": "⚠ **虚词占比低于下限的 19 份**（多半是 Fraktur／哥特体 OCR 认错字母）：",
  ...
  "eval_results": 64,
  "candidate_overall": 0.8512,
  "baseline_overall": 0.4906,
  "candidate_baseline_delta": 0.3606,
