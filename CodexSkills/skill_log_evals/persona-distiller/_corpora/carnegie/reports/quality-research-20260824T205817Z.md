...
- Phase: `research`
- Profile: `quick`
- Generated: `2026-08-24T20:58:17Z`
- Result: **FAIL**
...
- `research.no-source-ids`: references/research/04-external.md has substantive text but no source IDs
- `research.no-source-ids`: references/research/05-decisions.md has substantive text but no source IDs
