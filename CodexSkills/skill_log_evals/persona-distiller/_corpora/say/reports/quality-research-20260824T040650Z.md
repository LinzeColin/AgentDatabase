...
- Phase: `research`
- Profile: `quick`
- Generated: `2026-08-24T04:06:50Z`
- Result: **FAIL**
...
```json
{
  ...
  "material_split": {
    ...
    "**holdout 泄漏处**": 8,
    "**逐条**": [
      "✗✗ holdout 正文出现在此：src-003d387aca63  ← 隔离失效，本轮 known 分数不可信",
      "✗✗ holdout 正文出现在此：src-342c06541c14  ← 隔离失效，本轮 known 分数不可信",
      "✗✗ holdout 正文出现在此：src-7309a76950f4  ← 隔离失效，本轮 known 分数不可信",
      "✗✗ holdout 正文出现在此：src-d9920ebbab87  ← 隔离失效，本轮 known 分数不可信",
      "✗✗ holdout 正文出现在此：src-003d387aca63  ← 隔离失效，本轮 known 分数不可信",
      "✗✗ holdout 正文出现在此：src-342c06541c14  ← 隔离失效，本轮 known 分数不可信",
      "✗✗ holdout 正文出现在此：src-7309a76950f4  ← 隔离失效，本轮 known 分数不可信",
      "✗✗ holdout 正文出现在此：src-d9920ebbab87  ← 隔离失效，本轮 known 分数不可信"
