...
KEY = json.loads((pathlib.Path("round1") / "lp_blind_key.json").read_text(encoding="utf-8"))
...
for seat, fn in (("seat-D-score-v1", "lp_judge_D.json"), ("seat-E-strict-v1", "lp_judge_E.json")):
    f = SP / fn
