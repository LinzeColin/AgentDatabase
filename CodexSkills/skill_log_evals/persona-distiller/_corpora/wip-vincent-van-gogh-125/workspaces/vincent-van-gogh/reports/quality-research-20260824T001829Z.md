...
- Phase: `research`
- Profile: `quick`
- Generated: `2026-08-24T00:18:29Z`
- Result: **FAIL**
...
- `corpus.holdout-work-named-in-artifacts`: **建模者读得到的文件里有 3 处直接说出了 holdout 是哪一份**（书名／卷次页码／文件名／源 id）——这比「提到有个 holdout」严重得多，**它把那道题考什么也告诉了**。　[('01-writings.md', 51), ('02-conversations.md', 69), ('04-external.md', 57)]
- `corpus.holdout-mentioned-in-artifacts`: **建模者读得到的文件里有 3 处提到 holdout**——知道「存在一份取不到的材料、它关于某某」已足够定位那道题。　[('01-writings.md', 'holdout'), ('02-conversations.md', 'holdout'), ('04-external.md', 'holdout')]
