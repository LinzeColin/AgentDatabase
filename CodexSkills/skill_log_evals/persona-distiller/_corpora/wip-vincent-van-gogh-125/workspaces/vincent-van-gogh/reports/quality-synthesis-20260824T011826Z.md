...
- Phase: `synthesis`
- Profile: `quick`
- Generated: `2026-08-24T01:18:26Z`
- Result: **PASS**
...
```json
{
  ...
  "quote_layer": {
    ...
    "**这些地方分不清原文与译文**": [
      ...
      "case-known-2　有 1 处外语引文而**全文无引文层标注**（首处：「Colour as colour means something…）——**读者无从知道那是原文还是译文**",
      ...
      "case-trajectory-1　有 2 处外语引文而**全文无引文层标注**（首处：「One cannot be at the Pole and at the Equato…）——**读者无从知道那是原文还是译文**",
      "case-trajectory-2　有 2 处外语引文而**全文无引文层标注**（首处：「One cannot be at the Pole and at the Equato…）——**读者无从知道那是原文还是译文**",
  ...
  "activation_yield": {
    ...
    "输出": [
      ...
      "   bookkeeping_lines: 1",
      "   payload_lines: 31",
      "   bookkeeping_ratio: 0.0312",
      "   payload_ratio: 0.9688"
    ]
  },
  "anchor_coherence": {
    "退出码": 0,
