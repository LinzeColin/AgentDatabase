...
- Phase: `synthesis`
- Profile: `quick`
- Generated: `2026-08-25T00:44:14Z`
- Result: **FAIL**
...
```json
{
  ...
  "content_review": {
    ...
    "research_quote": "**有引文未在语料中找到**——未命中不等于伪造，须人工核对；但「改了 OCR 错字再当逐字引文」也落在这里。引文 90 条，切分后核验片段 86 个，未命中 2 个，长 s 还原后才命中 0 个｜⚠ 研究/04-external.md: 「Lippincott 编者（1928，Wanamaker 身后五年）的卷首语直接描述传主的朋友 Wanamaker： > From his earliest days John Wanamaker w」｜⚠ 研究/04-external.md: 「vision（远见）/voluminous writer（多产作家）」",
  ...
  "evidence_per_claim": {
    "断言条数": 15,
    "source_ids": "逐条各异（非空 15/15，不同取值 15）",
  ...
  "activation_yield": {
    "状态": "输入不在（/Users/linzezhang/Documents/Codex/GithubProject/AgentDatabase/CodexSkills/skill_log_evals/persona-distiller/_corpora/wanamaker/evals/judge_payload.v1.json），**未核验**（不是通过）"
  },
  "anchor_coherence": {
    "退出码": 0,
    "输出": [
      "   100.0%  decision-policy.md     clm-e0673e9781ee",
      "           **启发式：把教育当长期投资，宁可先投入也要\"从基层培养\"**——1909 年《Commercial Institute》 `my confidence and firm be…",
      "",
  ...
  "delivery_denominators": {
    "状态": "输入不在（/Users/linzezhang/Documents/Codex/GithubProject/AgentDatabase/CodexSkills/skill_log_evals/persona-distiller/_corpora/wanamaker/audit/source-coverage.json），**未核验**（不是通过）"
  },
