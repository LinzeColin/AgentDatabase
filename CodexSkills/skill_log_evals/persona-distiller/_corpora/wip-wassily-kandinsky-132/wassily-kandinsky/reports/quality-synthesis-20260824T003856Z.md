...
- Phase: `synthesis`
- Profile: `quick`
- Generated: `2026-08-24T00:38:56Z`
- Result: **FAIL**
...
```json
{
  ...
  "activation_yield": {
    "状态": "输入不在（/Users/linzezhang/Documents/Codex/GithubProject/AgentDatabase/CodexSkills/skill_log_evals/persona-distiller/_corpora/wip-wassily-kandinsky-132/wassily-kandinsky/evals/judge_payload.v1.json），**未核验**（不是通过）"
  },
  "anchor_coherence": {
    "退出码": 0,
    "输出": [
      "     0.0%  persona.md             clm-3a7c1e9f5b8d",
      "           艺术服务于精神的觉醒与内在真实：真正艺术的根在「人类灵魂深处」（der menschlichen Seele），而非市场、流派或技术炫耀。…",
      "",
...
- `ledger.invalid`: clm-8d5c2f7a4e1b has invalid status
- `ledger.invalid`: clm-2f9b6d4a8c3e has invalid status
- `ledger.invalid`: clm-5c8e2a9f4d7b has invalid status
- `ledger.invalid`: clm-4a7d2f8c1e9b has invalid status
- `ledger.invalid`: clm-6b9e3d1f8a2c has invalid status
- `ledger.invalid`: clm-3a7c1e9f5b8d has invalid status
- `ledger.invalid`: clm-9e2b6f4a1d8c has invalid status
- `ledger.invalid`: clm-c4f8a2d7e1b9 has invalid status
- `corpus.holdout-work-named-in-artifacts`: **建模者读得到的文件里有 2 处直接说出了 holdout 是哪一份**（书名／卷次页码／文件名／源 id）——这比「提到有个 holdout」严重得多，**它把那道题考什么也告诉了**。　[('facts.md', 19), ('claims.jsonl', 13)]
- `corpus.holdout-mentioned-in-artifacts`: **建模者读得到的文件里有 2 处提到 holdout**——知道「存在一份取不到的材料、它关于某某」已足够定位那道题。　[('facts.md', 'holdout'), ('claims.jsonl', 'holdout')]
- `claim.model-minimum`: mental models 0 < 2
- `claim.heuristic-minimum`: heuristics 0 < 3
- `claim.no-falsifier`: clm-2f9b6d4a8c3e lacks falsification/downgrade conditions
- `claim.no-falsifier`: clm-5c8e2a9f4d7b lacks falsification/downgrade conditions
- `claim.no-falsifier`: clm-4a7d2f8c1e9b lacks falsification/downgrade conditions
- `claim.no-falsifier`: clm-6b9e3d1f8a2c lacks falsification/downgrade conditions
- `claim.no-falsifier`: clm-3a7c1e9f5b8d lacks falsification/downgrade conditions
- `claim.no-falsifier`: clm-c4f8a2d7e1b9 lacks falsification/downgrade conditions
...
- `claim.orphan`: active Claim clm-6b9e3d1f8a2c is not rendered in any core artifact
