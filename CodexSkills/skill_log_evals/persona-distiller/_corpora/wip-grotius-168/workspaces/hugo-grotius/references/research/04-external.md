...
### C-09（方法性）判断「这本书是不是针对他的」，**看题名页与章题，不看正文提名次数**

- **依据**：观察 一（De Laet *Responsio* 题名页直书驳他那篇第二论文，
  而全书 16.7 万字符只 2 处姓名；Selden 第 XXVI 章题点名，114 万字符只 8 处）
  ＋ 观察 二（`Grotivs`／`Grotim`／`Grot` 等变体，
  在 De Laet *Notae* 上字面检索漏检率 **91.7%**）。
- ★ 这条**对本项目自己也成立**——我最初正是被那 8 次误导，
  差点判成「抓错了源」。

### C-10（**证据缺口**）「他的论敌当时怎么说他」拿不到逐字引文

- **依据**：观察 三（三份一手论战文本讹字率 0.9022／0.9708／0.9957 全部不可用；
  唯一干净的是 1826 年二手传记）。
- **可检验**：产物中凡出现「Selden 反驳说……」「De Laet 指出……」形态的句子，
  **都没有可核依据**；只能引 1826 年那位传记作者的转述，**并注明是转述**。

## Contradictions and alternative explanations

### X-06 「正文少提名」与「名字被 OCR 读坏了」，本道的证据同时支持两者

观察二已证明姓名有大量变体。逐处读命中只能证明「书确实是针对他的」，
**不能定量拆开这两种成因**。所以 C-09 只说「怎么判断」，
**不说「17 世纪论战文体少提对手姓名」**——后者本道立不住。

## Unknowns and source gaps

- 四份**都没有通读**；三条观察分别是命中计数、形态频次、判据实测表。
- **没有查 Butler 1826 的转述是否忠于原始文献**——它是二手，本道不判其准确性。
- Selden 与 De Laet 的**论点一条都没读**，只读到「书是针对他的」。
