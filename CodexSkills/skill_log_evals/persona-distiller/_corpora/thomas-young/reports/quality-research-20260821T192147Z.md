...
- Phase: `research`
- Profile: `quick`
- Generated: `2026-08-21T19:21:47Z`
- Result: **FAIL**
...
```json
{
  ...
  "content_review": {
    ...
    "fraktur_mojibake": "⚠ **德文语料 0 份 —— 未核，不是通过**（「没有花体乱码」在空集上恒真；共读到 13 份）",
