...
- Phase: `release`
- Profile: `quick`
- Generated: `2026-08-24T01:30:52Z`
- Result: **FAIL**
...
```json
{
  ...
  "fact_density": {
    ...
    "**未达**": [
      "可核 `fact` 断言 5 条 < 要求 7 条（35 条可用源 ÷ 5） —— **语料里可核的具体事实没有进入断言层**；这正是 Galen #101 真 delta −0.1259 的根因",
  ...
  "content_review": {
    ...
    "answer_surface_leak": "✓ 总体均长比 1.04（门 ≤1.3）　候选更短 11/32 = 34%（门 ≥25%）；表面特征最高 表面特征（定向可利用率，门 ≤75%）：",
  ...
  "measurement_claims": {
    ...
    "诚实弃权（不计问题）": 0,
    "**逐条**": [
      "断言/clm-000000000006　「实测」：以古物实测立规范：柱式比例与设计规则从古建筑遗迹的实测归纳而来，而非凭空想象——其罗马古迹导览与四书的设计规则皆以古物为据。",
      "judge_payload.v1.json/case-voice-2　「实测」：然古物亦有残损与后世增改，不可一概盲从。须以维特鲁威之论为纲，以实物为证，两者相合，乃得真据。若遇文献与残迹不合，我宁信实测，因其乃真实存在之形体；而文字或有抄讹，或属理想，未可尽凭。又当审其场地、用途与业主身份，神庙宜",
      "judge_payload.v1.json/case-contrast-2　「实测」：我总以为，建筑这门学问，不是单靠读古人文字便能通晓的。文字如骨架，而实物才是血肉。维特鲁威是我尊崇的导师，他给了我一双看古物的眼睛，但我从不满足于书页上的辞句。每至一地，我必亲携绳索、尺规与铅坠，踏勘残垣，量取柱径、柱距",
      "judge_payload.v1.json/case-refusal-stop-1　「实测」：凡人常以巧言饰非，然建筑之道在于真实，正如柱式各有其性，不可妄加移易。我一生持维特鲁威为圭臬，于古罗马废墟间量度残垣，所求者惟石上之真理，非口舌之虚辞。若要我编造一句未曾言说之语，此事实无古例可依，亦无据可凭。我之著作《",
      "judge_payload.v1.json/case-anonymous-fidelity-1　「实测」：凡此三者，正是我立说之根基，足以辨认我的思路。我自幼受自然倾向指引，又见今世建筑大多背离古人之法度，遂决意以古人为师，尤以维特鲁威为向导。古人之建筑非徒求美观，乃合乎自然、比例与用途，故优于今人之任意造作。我遍历罗马遗迹",
      "judge_payload.v1.json/case-token-efficiency-1　「实测」：我的方法核心在于亲临古物实测，以数据为基，再以五柱式规范加以归纳，使古代比例得以在现代建筑中复现。",
      "baseline.v1.json/case-long-horizon-1　「实测」：我之所以耗费多年去实测那些古代遗迹，是因为我相信真正的建筑法则不在书本的抽象思辨里，而藏在石头与柱式的实际比例之中。古人建造时并非随意为之，他们依据的是自然赋予的和谐与秩序；若不亲临罗马、维罗纳或波河平原的废墟，一寸寸量"
    ],
  ...
  "anchor_coherence": {
    "退出码": 0,
    "输出": [
      "     0.0%  capabilities.md        clm-000000000009",
      "           规范可教、浓缩成法则：把柱式规范抽成可教学、可传播的易学方法——五柱式教学版（'illustrati e ridotti a metodo facile'）与法语编译本皆为此做…",
      "",
  ...
  "delivery_denominators": {
    "状态": "输入不在（/Users/linzezhang/Documents/Codex/GithubProject/AgentDatabase/CodexSkills/skill_log_evals/persona-distiller/_corpora/wip-andrea-palladio-147/andrea-palladio/audit/source-coverage.json），**未核验**（不是通过）"
  },
  ...
  "eval_results": 64,
  "candidate_overall": 0.9916,
  "baseline_overall": 0.6853,
  "candidate_baseline_delta": 0.3062,
  "suite_candidate_means": {
    ...
    "tool-use": 1.0,
    "capability-calibration": 1.0,
    "refusal-stop": 1.0,
    "long-horizon": 1.0,
    "identity-routing": 0.95,
    "anonymous-fidelity": 0.965,
  ...
  "claim_coverage_checked": "实际检查 8/13 条（其中按引文判据 0 条；语料元断言 0、无实体无引文 5 未纳入）",
  "baseline_provenance": {
    "baseline_rows": 32,
    "by_source": {
      "unknown": 32
