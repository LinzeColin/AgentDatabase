...
```json
{
  ...
  "evidence_per_claim": {
    "断言条数": 19,
    "source_ids": "逐条各异（非空 19/19，不同取值 16）",
...
- `claim.insufficient-support`: clm-f97934655d01 needs at least two supporting sources
- `claim.insufficient-support`: clm-81668e41786e needs at least two supporting sources
- `claim.insufficient-support`: clm-9342e6a97b63 needs at least two supporting sources
