...
- Phase: `release`
- Profile: `quick`
- Generated: `2026-08-22T17:50:03Z`
- Result: **FAIL**
...
- `eval.known-no-holdout`: ef-known-02 known case has no Holdout source
- `content.quote-no-locator`: 有逐字引文无从回查：同段内既无年份也无卷页刊名。长逐字引文 175 条，同段带坐标 157 条，**缺坐标 18 条**
