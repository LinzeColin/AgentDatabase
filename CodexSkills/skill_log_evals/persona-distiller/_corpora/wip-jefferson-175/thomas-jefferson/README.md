# Thomas Jefferson 人物 Skill

- 构建器：Persona Distiller `v0.0.0.5`
- 目录/Skill 名：`thomas-jefferson`
- 构建主身份：政治法律师
...
默认安装到 `~/.codex/skills/thomas-jefferson`。研究工作区包含原始/受限材料；发布 ZIP 默认只带运行所需模型、审计摘要和安全更新模板。
