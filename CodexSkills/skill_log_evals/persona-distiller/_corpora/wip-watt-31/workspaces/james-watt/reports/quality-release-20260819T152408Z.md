...
- Phase: `release`
- Profile: `quick`
- Generated: `2026-08-19T15:24:08Z`
- Result: **FAIL**
...
```json
{
  ...
  "content_review": {
    ...
    "answer_surface_leak": "✓ 总体均长比 0.93（门 ≤1.3）　候选更短 18/32 = 56%（门 ≥25%）；表面特征最高 表面特征（定向可利用率，门 ≤75%）：",
  ...
  "activation_yield": {
    ...
    "输出": [
      ...
      "   substantive_lines: 77",
      "   bookkeeping_lines: 4",
      "   payload_lines: 73",
      "   bookkeeping_ratio: 0.0519",
      "   payload_ratio: 0.9481"
    ]
  },
  "anchor_coherence": {
    "退出码": 0,
  ...
  "eval_results": 64,
  "candidate_overall": 0.8819,
  "baseline_overall": 0.775,
  "candidate_baseline_delta": 0.1069,
  "suite_candidate_means": {
    ...
    "trajectory": 0.91,
    "contrast": 0.915,
    "fact-preservation": 0.94,
    "style-decoy": 0.9,
    "task-completion": 0.87,
  ...
  "claim_coverage_checked": "实际检查 11/18 条（其中按引文判据 0 条；语料元断言 0、无实体无引文 7 未纳入）",
  "baseline_provenance": {
    "baseline_rows": 32,
    "by_source": {
      "unknown": 32
...
- `content.self-count-wrong`: **自报字数与实数对不上**——主动邀请核对的数字自己错了，比不给更伤。　⚠ case-style-decoy-2: 自称「字数二字」，实数 15（含标点 18／不含 15）：「我不替任何厂牌作背书，更不写"最佳"」
