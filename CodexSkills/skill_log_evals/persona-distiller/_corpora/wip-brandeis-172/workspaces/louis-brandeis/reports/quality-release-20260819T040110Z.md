...
- Phase: `release`
- Profile: `quick`
- Generated: `2026-08-19T04:01:10Z`
- Result: **FAIL**
...
```json
{
  ...
  "rubric_health": {
    ...
    "**判据要求出戏的**": {
      "lb-fact-preservation-01": [
        [
          "资料层词",
          "说出至少两家公司名并把两档分开，加分。\\n★ 数字允许有小数位上的出入（原文是 OCR 扫描），但**两档的高低关系必须对**。', '失败条件': '只说「很高」而"
        ],
        [
          "资料层词",
          "两家公司名并把两档分开，加分。\\n★ 数字允许有小数位上的出入（原文是 OCR 扫描），但**两档的高低关系必须对**。', '失败条件': '只说「很高」而给不出"
        ]
      ]
    },
  ...
  "eval_results": 64,
  "candidate_overall": 0.8644,
  "baseline_overall": 0.6522,
  "candidate_baseline_delta": 0.2122,
...
- `eval.rubric-demands-frame-break`: **1 条 rubric 把「谈资料库/扫描件/未收录」写成了得分条件**：lb-fact-preservation-01 —— 人物说那种话就是出戏，而同一份盲判指令又要评委扣「出戏」。**现在改还来得及。**
