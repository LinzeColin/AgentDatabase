...
- Phase: `release`
- Profile: `quick`
- Generated: `2026-08-20T23:49:01Z`
- Result: **FAIL**
...
```json
{
  ...
  "content_review": {
    "shared_anchor": "⚠ 只列不判，须逐组人工读：32 题里有 4 组引了同一段语料。**逐组读一遍，看结论有没有互相否定——本件不判这个。**",
    ...
    "answer_surface_leak": "✓ 总体均长比 1.04（门 ≤1.3）　候选更短 16/32 = 50%（门 ≥25%）；表面特征最高 表面特征（定向可利用率，门 ≤75%）：",
  ...
  "eval_results": 128,
  "candidate_overall": 0.9047,
  "baseline_overall": 0.4427,
  "candidate_baseline_delta": 0.462,
  "suite_candidate_means": {
    ...
    "planning-fidelity": 0.9025,
    "tool-use": 0.9125,
    "capability-calibration": 0.895,
    "refusal-stop": 0.905,
    "long-horizon": 0.9,
    "identity-routing": 0.8925,
    "anonymous-fidelity": 0.8925,
    "token-efficiency": 0.9175
  },
  "suite_single_drag": {
    "未过阈值的套组": 1,
    "整组偏弱": [
      "fact-preservation　均分 0.9250 < 0.93　整组偏弱（去掉最低仍 0.9250）"
    ],
  ...
  "claim_coverage_checked": "实际检查 30/31 条（其中按引文判据 4 条；语料元断言 0、无实体无引文 1 未纳入）",
  "baseline_provenance": {
    "baseline_rows": 64,
    "by_source": {
      "unknown": 64
...
- `model.placeholder`: work.md is not substantive enough for release
- `content.quote-no-locator`: 有逐字引文无从回查：同段内既无年份也无卷页刊名。长逐字引文 112 条，同段带坐标 71 条，**缺坐标 41 条**
