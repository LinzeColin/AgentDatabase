...
- Phase: `release`
- Profile: `quick`
- Generated: `2026-08-21T00:05:18Z`
- Result: **FAIL**
...
```json
{
  ...
  "claim_coverage_checked": "实际检查 30/31 条（其中按引文判据 0 条；语料元断言 0、无实体无引文 1 未纳入）",
  "baseline_provenance": {
    "baseline_rows": 64,
    "by_source": {
      "unknown": 64
...
- `claim.orphan`: active Claim clm-000000000013 is not rendered in any core artifact
