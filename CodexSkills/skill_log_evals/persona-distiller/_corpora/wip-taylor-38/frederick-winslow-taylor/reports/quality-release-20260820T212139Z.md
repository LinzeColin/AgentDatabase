...
- Phase: `release`
- Profile: `quick`
- Generated: `2026-08-20T21:21:39Z`
- Result: **FAIL**
...
```json
{
  ...
  "content_review": {
    ...
    "answer_surface_leak_baseline_source": "self-authored-strawman",
    ...
    "gate_reachability": "⚠ **未核，不是通过** —— 没有可用的判分数据——**本次未检查（不是通过）**",
    "absence_claims": "⚠ 标记的须人工确认依据；本脚本不做自动判定",
    "claim_anchors": "✗ **/Users/linzezhang/Documents/Codex/GithubProject/AgentDatabase/CodexSkills/skill_log_evals/persona-distiller/_corpora/wip-taylor-38/frederick-winslow-taylor/",
  ...
  "claim_coverage_checked": "实际检查 0/0 条（其中按引文判据 0 条；语料元断言 0、无实体无引文 0 未纳入）",
  "baseline_provenance": {
    "baseline_rows": 0,
    "by_source": {},
    "usable_rows": 0,
...
- `model.placeholder`: cognitive-os.md is not substantive enough for release
- `model.placeholder`: decision-policy.md is not substantive enough for release
...
- `eval.no-results`: release phase requires evaluation results

## Warnings

- `eval.baseline-not-capability-evidence`: 没有任何 baseline 记录——delta 无从谈起
