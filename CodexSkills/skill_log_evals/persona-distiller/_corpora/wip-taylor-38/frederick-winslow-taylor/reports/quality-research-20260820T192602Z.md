...
- Phase: `research`
- Profile: `quick`
- Generated: `2026-08-20T19:26:02Z`
- Result: **FAIL**
...
```json
{
  ...
  "corpus_integrity": {
    ...
    "可疑": 0,
    "**账本有记录但文件不在**": [
      "raw-holdout/src-8aebeb3ab433/frederickwtaylor02copl.txt"
    ],
    ...
    "逐份": {
      ...
      "src-696c17b22d69": {
        ...
        "逐语域": {
          "英文": {
            "语域": "英文",
            "anchors_per_10k": 2284.4,
            "panel_good": 393,
            "panel_bad": 0,
            "若无语种门会读到": 0.0,
            "verdict": "干净",
            "rate": 0.0,
            "reason": "英文讹字率 0.0000（正形 393／讹形 0）"
          }
        },
        "verdict": "干净",
        "rate": 0.0,
        "reason": "英文讹字率 0.0000（正形 393／讹形 0）",
        "file": "cu31924085713331.txt"
      }
    }
  },
  "lane_scope": {
  ...
  "material_split": {
    ...
    "**holdout 泄漏处**": 1,
    "**逐条**": [
      "✗✗ holdout 正文出现在此：src-8aebeb3ab433  ← 隔离失效，本轮 known 分数不可信"
    ],
  ...
  "holdout_overlap": {
    ...
    "其中·无法判定": 0,
    "**逐条**": [
      "✗ src-8aebeb3ab433 **最长连续逐字段 230 词**（≥50 词的段共 58 处）",
      "✗ **非样板的连续逐字段 58 处 ≥ 50（最长 230 词）**"
    ],
