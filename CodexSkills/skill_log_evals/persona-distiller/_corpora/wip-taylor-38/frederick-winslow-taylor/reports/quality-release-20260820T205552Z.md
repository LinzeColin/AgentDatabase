...
- Phase: `release`
- Profile: `quick`
- Generated: `2026-08-20T20:55:52Z`
- Result: **FAIL**
...
```json
{
  ...
  "verbatim_quotes": {
    ...
    "跨版口命中（引文为真）": 0,
    "未命中样例": [
      "work.md: First. They develop a science for each element of a man's work, which replaces the old rule-of-thumb method. S"
    ],
    "跨版口样例": []
  },
  "semantic_residue": {
...
- content.verbatim-quote：1 条逐字引文在语料里找不到原样——**引文对不上就是引文对不上**
