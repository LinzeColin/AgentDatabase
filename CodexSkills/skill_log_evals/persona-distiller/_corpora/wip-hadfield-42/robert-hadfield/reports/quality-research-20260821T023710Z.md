...
- Phase: `research`
- Profile: `quick`
- Generated: `2026-08-21T02:37:10Z`
- Result: **PASS**
...
```json
{
  ...
  "namesake_criteria": {
    "**unknown 条数**": 2,
    "逐条": [
      "robert-hadfield：目标本人 7　他人 0　**unknown 2**",
      "· src-f8653062115e  [unknown] 既没命中排除名单，也没命中任何区分符——**这不是通过，是没核**。人工定夺或补一条区分符。",
      "· src-db7d79db2c67  [unknown] 既没命中排除名单，也没命中任何区分符——**这不是通过，是没核**。人工定夺或补一条区分符。"
    ],
...
- `corpus.namesake-unknown`: 同名归属说不准 2 条（**不是通过**）
