...
KEY = json.loads((pathlib.Path("round1") / "rv_blind_key.json").read_text(encoding="utf-8"))
...
for seat, fn in (("seat-D-score-v1", "rv_judge_D.json"), ("seat-E-strict-v1", "rv_judge_E.json")):
    f = SP / fn
