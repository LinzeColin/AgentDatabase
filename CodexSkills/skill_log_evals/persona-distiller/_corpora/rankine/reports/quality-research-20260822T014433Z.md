...
- Phase: `research`
- Profile: `quick`
- Generated: `2026-08-22T01:44:33Z`
- Result: **FAIL**
...
```json
{
  ...
  "content_review": {
    "byline_in_carrier": "核过 8 条，指错 0 条，**没核 1 条（不是通过）**",
    ...
    "research_quote": "**有引文未在语料中找到**——未命中不等于伪造，须人工核对；但「改了 OCR 错字再当逐字引文」也落在这里。引文 71 条，切分后核验片段 68 个，未命中 7 个，长 s 还原后才命中 0 个｜⚠ 研究/01-writings.md: 「Theory of Stability and Pressure of Earth」｜⚠ 研究/01-writings.md: 「Read January 27, 1870. See vol. xviii. p. 178」｜⚠ 研究/02-conversations.md: 「An absolutely fixed direction may be ascertained by means whose principles cannot be demonstrated un」｜⚠ 研究/02-conversations.md: 「The first law of motion may be regarded as a consequence of the definitions of force and of balance 」｜⚠ 研究/03-expression.md: 「Then L is a function of x, y, and z, Of the kind which is known as potential.」｜⚠ 研究/03-expression.md: 「My blessing on old George Stephenson! let his fame for ever last; For he was the man that found the 」",
  ...
  "verbatim_quotes": {
    ...
    "跨版口命中（引文为真）": 0,
    "未命中样例": [
      "01-writings.md: Read January 27, 1870",
      "01-writings.md: Theory of Stability and Pressure of Earth",
      "01-writings.md: Read January 27, 1870. See vol. xviii. p. 178"
    ],
    "跨版口样例": []
  },
  "semantic_residue": {
...
- `corpus.holdout-work-named-in-artifacts`: **建模者读得到的文件里有 1 处直接说出了 holdout 是哪一份**（书名／卷次页码／文件名／源 id）——这比「提到有个 holdout」严重得多，**它把那道题考什么也告诉了**。　[('02-conversations.md', 63)]
- `corpus.holdout-mentioned-in-artifacts`: **建模者读得到的文件里有 3 处提到 holdout**——知道「存在一份取不到的材料、它关于某某」已足够定位那道题。　[('02-conversations.md', 'holdout'), ('02-conversations.md', 'holdout'), ('03-expression.md', 'holdout')]
- `research.invalid-source`: references/research/02-conversations.md cites non-train or unknown sources: ['src-49fe5736e7d6', 'src-b09cb45a5e8f']

## Warnings

- content.verbatim-quote：3 条逐字引文在语料里找不到原样——**引文对不上就是引文对不上**
