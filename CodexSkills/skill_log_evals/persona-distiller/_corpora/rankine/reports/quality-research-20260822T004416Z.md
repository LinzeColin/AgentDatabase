...
- Phase: `research`
- Profile: `quick`
- Generated: `2026-08-22T00:44:16Z`
- Result: **FAIL**
...
```json
{
  ...
  "holdout_overlap": {
    ...
    "其中·无法判定": 0,
    "**逐条**": [
      "✗ src-b09cb45a5e8f  philtrans08776343.txt",
      "✗ 有 holdout 的内容已在 train 中出现——**必须换源**。"
    ],
...
- `research.authorship-unproven`: src-b09cb45a5e8f philtrans08776343.txt｜文中他人署名：无 —— 账本声称本人所著，但文中查无归属证据（署名／编者注／逐字稿轮次三者皆无）
