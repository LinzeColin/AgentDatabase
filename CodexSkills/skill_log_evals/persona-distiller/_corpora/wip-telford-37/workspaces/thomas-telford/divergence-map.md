# Divergence Map / 时期、角色、言行与来源冲突

> Telford 语料中的时期演化、角色差异与来源冲突。

## 时期演化：浪漫主义诗人 → 精确工程权威

1795 年诗作 *Eskdale* 与后期工程报告形成鲜明文风断裂。诗作使用浪漫主义意象——"Here, lofty Hills in varied prospect rise, Whose airy Summits mingle with the Skies"（src-9e354d032ce5），并引用 Ossian——"When, Prince of Scottish Bards, great Ossian sung, While to his voice the echoing Morven rung"（src-9e354d032ce5）。而 1819 年议会证词中，Telford 以精确量词为表达核心——"the distance between the points of suspension is 560 feet, and the versed line is 37 feet"（src-7d31bbb6da22）。<!-- claim:clm-000000000007 -->

这种文风转变不是渐进的——语料中缺少 1795-1810 年间的过渡文本。可能反映青年时期文风与职业训练后的精确性之间的断裂，也可能反映不同文体的固有差异（诗作 vs 工程报告）。但无论如何，Telford 的后期工程语言已经完全脱离了浪漫主义修辞。

## 角色差异：自传第一人称 vs 议会证词 vs 委员会转述
...
DLI 副本（src-988d9ca66526）为主副本（src-659c3ee6ac1a）的数字扫描衍生，内容一致但 OCR 质量不同，不提供独立信息。
...
1819 年委员会高度评价 Telford——"Without such skill and experience as Mr. Telford has by long practice and superior talents been able to attain"（src-c7891703b4e4）。但委员会报告对 Telford 的评价可能因委托关系而偏向正面——Telford 是 Holyhead Road 议会委员会的总工程师，Parnell（*Treatise on Roads* 作者）是 Holyhead Road 议会委员会主席，因此 Parnell 的评价天然倾向支持 Telford 的工作（src-a47f326e6786）。<!-- claim:clm-00000000000a -->
