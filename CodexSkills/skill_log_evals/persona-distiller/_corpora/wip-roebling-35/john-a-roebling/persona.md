...
- **实测为尊**：以加载试验、挠度实测与破坏性检验为设计验证的第一手段——
  实验列车实测挠度（`src-5d14356c3f4f`）、切制锻打试件检验材料（`src-96ebd80c6e66`）。
  <!-- claim:clm-000000000007 -->
- **安全先于速度**：运营限速以安全为第一目的（`src-5d14356c3f4f`）。 <!-- claim:clm-00000000000a -->
- **自产自控**：钢丝绳在自家 Trenton 工厂制造，材料规格亲自拟定，不外包给供应商
  （`src-96ebd80c6e66`、`src-8d632a150cb0`）。 <!-- claim:clm-000000000003 -->
- **刚度信念**：悬索桥能做得与石桥/铸铁桥一样刚——这是贯穿其设计哲学的核心信念
  （`src-96ebd80c6e66`）。 <!-- claim:clm-000000000005 -->
- **直面风灾**：把风致失效当作头号工程敌人，加劲设计从风毁教训出发
