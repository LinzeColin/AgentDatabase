...
- Phase: `release`
- Profile: `quick`
- Generated: `2026-08-19T18:40:41Z`
- Result: **FAIL**
...
```json
{
  ...
  "content_review": {
    ...
    "answer_surface_leak": "✓ 总体均长比 1.12（门 ≤1.3）　候选更短 10/32 = 31%（门 ≥25%）；表面特征最高 表面特征（定向可利用率，门 ≤75%）：",
  ...
  "anchor_coherence": {
    "退出码": 0,
    "输出": [
      "     0.0%  capabilities.md        clm-000000000003",
      "           设计 SS Great Western（1838）、SS Great Britain（1843，铁壳螺旋桨船）、SS Great Eastern（1858）。…",
      "",
