...
KEY = json.loads((pathlib.Path("round1") / "jl_blind_key.json").read_text(encoding="utf-8"))
...
for seat, fn in (("seat-D-score-v1", "jl_judge_D.json"), ("seat-E-strict-v1", "jl_judge_E.json")):
    f = SP / fn
