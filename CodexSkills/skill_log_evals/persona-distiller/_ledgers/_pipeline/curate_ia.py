...
EXCLUDE = {
    ...
    # ★ Andrea Palladio #147：池内现代噪声（slides/thingiverse/视频/旅游 guide）由版次年与
    #   访问受限筛掉；creator 侧裸 `Andrea Palladio`/`Palladio, Andrea, 1508-1580` 全为本尊。
    #   无需要按 creator 串排除的同名者（现代 Caroline Constant《Palladio Guide》creator 字段
    #   不含 palladio，由 REQUIRE 天然挡掉；Bertotti Scamozzi 是图集编者非同名者）。
    "palladio": [],
    # ★ Wassily Kandinsky #132（1866-1944，抽象艺术理论家）：同名者为 Victor Kandinsky
    #   （1849-1889 俄国精神病学家，1885《Kritische und klinische Untersuchungen》）、
    #   Carla Kandinsky（现代诗人）、Nina Kandinsky（其妻 1899-1980，回忆录作者）。
    #   REQUIRE 钉 kandinsky+wassily；西里尔 creator（Василий Кандинский / Vasily Kandinsky）
    #   单列词元收。
    "kandinsky": ["Victor Kandinsky", "Carla Kandinsky", "Nina Kandinsky", "Kandinsky, Nina"],
    # ★ Leon Battista Alberti #146（1404-1472，文艺复兴人文学家/建筑师）：同名者多为
...
EXCLUDE_TITLE = {
    ...
    "mill": [],
    "franklin": [],
    # ★ Alberti #146：混编卷/他人著作而 creator 里含 Alberti 的，按题名排：
...
REQUIRE = {
    ...
    # ★ Leon Battista Alberti #146：目标署名形态 `Alberti, Leon Battista, 1404-1472`／
    ...
    # ★ Wassily Kandinsky #132：署名形态 `Kandinsky, Wassily, 1866-1944`／`Wassily Kandinsky`／
    #   西里尔 `Кандинский, Василий`／`Vasily Kandinsky`／`Vassily Kandinsky`。
    #   REQUIRE 钉 kandinsky+wassily 及其西里尔/变体词元。
    "kandinsky": [["kandinsky", "wassily"], ["kandinsky", "vasily"],
                  ["kandinsky", "vassily"], ["кандинский"]],
    # ★ Andrea Palladio #147：目标署名形态 `Palladio, Andrea, 1508-1580`／`Andrea Palladio`／
    #   `Palladio, Andrea (1508-1580); Bertotti Scamozzi, Ottavio`（图集合著，目标第一作者）／
    #   拉丁 `Andreas Palladius Vicentinus`（1570/1580 四书意大利条目）。
    #   REQUIRE 钉 palladio+andrea（词元匹配，名序不论）；拉丁条目单列 palladius 词元收。
    "palladio": [["palladio", "andrea"], ["palladius"]],
}
