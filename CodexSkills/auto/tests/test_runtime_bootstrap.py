...
from CodexSkills.auto.runtime.orchestrator import SkillOpsOrchestrator
from CodexSkills.auto.runtime.roots import RootEntry
...
class RuntimeBootstrapTests(unittest.TestCase):
    ...
    def test_runtime_interface_is_byte_equivalent_and_not_a_trust_root(self) -> None:
        builder_path = REPO_ROOT / "CodexSkills/auto/tools/build_runtime_interface.py"
        ...
        interface_path = REPO_ROOT / "CodexSkills/auto/runtime-interface.json"
