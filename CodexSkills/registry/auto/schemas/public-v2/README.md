...
- the unchanged current 29-schema / five-policy candidate;
...
These files are intentionally outside the current recursive
`schemas/public/` loader, so their presence does not change the trusted 29/5
candidate. They are ready only for the next Mechanism-owned candidate,
consumer, and activation-control materialization phase. This promotion does
not bind a repository runtime, create a bundle, integrate a publisher or
writer, create `CodexSkills/VERSION`, activate, or permit canonical
publication.
