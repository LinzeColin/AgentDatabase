...
from CodexSkills.registry.auto.runtime.core import AutoRuntimeError, PROTOCOL
from CodexSkills.registry.auto.runtime.notification import NOTIFICATION_POLICY_ID
...
class RuntimeActivationTests(unittest.TestCase):
    ...
    def test_local_control_runtime_cannot_replace_external_object(self) -> None:
        with mock.patch(
            "CodexSkills.registry.auto.runtime.activation._git_blob",
