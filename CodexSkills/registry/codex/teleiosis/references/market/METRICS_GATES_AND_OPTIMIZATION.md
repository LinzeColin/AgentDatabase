...
| Decision | 触发 |
|---|---|
| EVIDENCE_READY_FOR_TELEIOSIS | 所有硬门、效果、保护任务、预算、证据等级和市场门通过 |
...
`EVIDENCE_READY_FOR_TELEIOSIS` 只覆盖冻结 Subject 与范围。实验室 EVIDENCE_READY_FOR_TELEIOSIS 不等于生产发布，L5 EVIDENCE_READY_FOR_TELEIOSIS 不等于 L6/L7 市场成熟。
