...
import market_lab  # noqa: E402
from marketlab.common import object_sha256, read_json, write_json, write_jsonl  # noqa: E402
from marketlab.experiments import (  # noqa: E402
    make_assignments,
    make_candidate_visible_dataset,
    make_holdout_manifest,
)
from marketlab.integrity import seal_tree, verify_tree  # noqa: E402
from marketlab.metrics import (  # noqa: E402
    aggregate_evidence,
    build_next_iteration_plan,
    decide_gate,
)
from marketlab.privacy import anonymize_feedback_rows  # noqa: E402
from marketlab.specs import validate_experiment_spec, validate_feedback, validate_task  # noqa: E402
from marketlab.stress import STRESS_CATEGORIES, expand_tasks  # noqa: E402


def load_spec() -> dict:
    return read_json(SKILL_ROOT / "assets" / "templates" / "experiment_spec.json")
...
class SkillStructureTests(unittest.TestCase):
    ...
    def test_skill_frontmatter_only_name_description(self):
        ...
        self.assertEqual(frontmatter["name"], "skill-market-lab")

    def test_no_extraneous_root_docs_inside_installable_skill(self):
        forbidden = {"README.md", "INSTALLATION_GUIDE.md", "QUICK_REFERENCE.md", "CHANGELOG.md"}
        self.assertFalse(forbidden & {path.name for path in SKILL_ROOT.iterdir()})
...
class AggregateAndGateTests(unittest.TestCase):
    def test_market_validated_candidate_promotes(self):
        spec = load_spec()
        ...
        self.assertEqual(gate["decision"], "PROMOTE", gate)
    ...
    def test_candidate_only_feedback_cannot_promote(self):
        spec = load_spec()
