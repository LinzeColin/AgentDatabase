...
def _create_db() -> Tuple[sqlite3.Connection, str]:
    temporary = tempfile.NamedTemporaryFile(prefix="skill-market-lab-", suffix=".sqlite3", delete=False)
    temporary.close()
...
def decide_gate(spec: Mapping[str, Any], summary: Mapping[str, Any]) -> Dict[str, Any]:
    assert_valid(validate_experiment_spec(spec), "实验规范")
