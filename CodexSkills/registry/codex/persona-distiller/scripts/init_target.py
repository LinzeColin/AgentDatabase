...
PROFILE_NOTE = {
    ...
    'quick': (
        '注：quick 的门是 来源 8 / 道 3 / 一手 4。\n'
        '    ★ **此前没有任何人物用它做过；Mendel #125 是第一个**——17 个工作区实测 14 deep / 2 standard / **1 quick（#125 Mendel，2026-08-05）**。\n'
        '      「它不用于发布」是我一度写在这里的说法，**代码与文档里都找不到依据**，已改成上面这个实测数。\n'
        '      要用 quick 发布是可以的，只是**没有先例**，判分那一段会踩到没人踩过的路。'),
}
