# Release verification — Persona Distiller v0.0.0.144

Date: 2026-08-05（**v0.0.0.144**）
...
| Release checksum 全量校验 | passed，**404 files**（`v0.0.0.144 实跑`；v0.0.0.96 写的 341、v0.0.0.75 写的 305 都是旧数——**这一行漂过三次，v0.0.0.111 起由 `check_verification_counts.py` 盯着**） | `self_check.py` |
