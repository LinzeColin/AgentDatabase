# Release verification — Persona Distiller v0.0.0.31
...
>
> 本次（v0.0.0.31）**是真的重跑了一遍**，下表每一行都是本次实跑输出。
...
| **★★ 真实夹具普查（v0.0.0.31 新增，只报不拦）** | **0 / 15 件的负对照里含真实样本夹具**——见下节 | `check_checkers.py scripts/` |
