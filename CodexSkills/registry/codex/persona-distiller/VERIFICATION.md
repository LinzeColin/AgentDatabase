# Release verification — Persona Distiller v0.0.0.29
...
>
> 本次（v0.0.0.29）**是真的重跑了一遍**，下表每一行都是本次实跑输出。
...
## ★★ v0.0.0.29 新增：归属依据门——**印刷时代之前的人物，靠什么证明是他写的**
...
## ★★ v0.0.0.29：**「名 + 姓」是一个西方近代假设，名册里大量人物不满足它**
...
### 三之前：**15 件检查器里，0 件的负对照含真实样本**（v0.0.0.29 新增普查）
