...
> 判据 **87** 件、Python 脚本 **125**、checksum 全量校验 **465 files**、身份族 **12** 族、**名册 102 人**。
...
> ★★ **2026-08-11 第三次更新**：判据 86→**87**、脚本 123→**125**、checksum 460→**465**。
...
> `ls scripts/check_*.py | wc -l` = 87、`ls scripts/*.py | wc -l` = 125、`wc -l < checksums.sha256` = 465、products = 102。
