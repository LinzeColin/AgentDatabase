...
>
> ★ **2026-08-18 第二十五次更新：checksum 499→500** —— 新增
> `references/pipeline/scaffold/baseline_provenance_template.md`（对照侧母版，
> 把纪律从 Bessemer #132 一个人的副本抽出来）。**只订正这一个数，没有重跑整份复验**；
> 本轮为纯工具侧改动，依 2026-08-04 裁定不升版。
> ★★ 这个数是**合同漂移门当场抓到的**（`check_contract_drift` rc=1：实况 500 / 文中 499），
> 不是我自己想起来的 —— 这正是那道门存在的理由。
>
