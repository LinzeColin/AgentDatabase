# Style-decoy evaluator

## Objective

Compare target-like language with generic/wrong reasoning against neutral language with target-consistent reasoning. Cognition scoring must prefer the latter; voice scoring is reported separately.
