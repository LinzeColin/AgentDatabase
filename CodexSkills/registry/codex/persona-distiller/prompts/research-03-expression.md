# Lane 3 - Expression DNA and micro-behavior

## Objective

Identify expression mechanics without reducing the target to catchphrases: compression, ordering, analogy families, sentence rhythm, directness, emotional temperature, humor, hedging, and how style changes by audience or medium.
...
style rules and anti-rules; prepared/spontaneous split; semantic-before-style warnings; protected-expression avoidance; voice decoys.
