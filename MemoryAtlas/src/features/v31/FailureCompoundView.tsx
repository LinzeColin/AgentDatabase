  ...
  return (
    <div className="ma31-view ma31-failure-compound" data-v31-view="failureCompound">
      ...
      <header className="ma31-view-heading">
        <div><p className="ma31-kicker">失败沉淀为回归资产</p><h1>失败复利</h1>
      ...
      <section className="ma31-metrics">
        <MetricCard label="错误条目" value={formatNumber(metrics?.incident_count)} note="同类错误按签名去重" />
        <MetricCard label="活跃回归资产" value={formatNumber(metrics?.active_regression_assets)} note="复现夹具＋判据＋测试" />
