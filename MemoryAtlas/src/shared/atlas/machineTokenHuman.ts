...
export const machineTokenLabels: Record<string, string> = {
  ...
  archive: "归档",
  promote: "提升",
  // Incident ledger, coverage and behaviour states, found by auditing against
  // the data production actually serves rather than the build-time snapshot.
  OPEN: "未关闭",
  CLOSED: "已关闭",
  REOPENED: "已复发",
  READY: "就绪",
  ...
  augmentation: "增强协作",
  automation: "自动化",
  mixed_or_unknown: "混合或未标注",
  data_integrity: "数据完整性",
  origin_connectivity: "源站连通性",
  production_origin_routing: "生产源站路由",
  promotion_control_flow: "晋级控制流",
  promotion_process_identity: "晋级进程身份",
  protected_runtime_path: "受保护运行路径",
  capacity_failure: "容量不足",
  candidate_oracle_mismatch: "候选与判据不一致",
  frozen_fixture: "冻结夹具",
