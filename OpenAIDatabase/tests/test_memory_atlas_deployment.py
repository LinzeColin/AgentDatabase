...
class MemoryAtlasDeploymentTests(unittest.TestCase):
    def test_cloudflare_workers_ready_config_and_current_pages_access_delivery_exist(self) -> None:
        ...
        self.assertEqual(wrangler["assets"]["directory"], "../MemoryAtlas/dist")
        ...
        self.assertIn("Build output directory: MemoryAtlas/dist", docs)
        ...
        self.assertIn("wrangler pages deploy ../MemoryAtlas/dist", runbook)
