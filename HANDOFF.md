...
| 2 | **Leonardo da Vinci #184** | **阶段 1a–2 跑通，过 quick 档**（一手 55／占比 0.8871／道 3；standard/deep 够不着因为道 3<6）。语料 62/70 已备、570 万词、意大利原文 35 份。★ 声口按**动词**量是 3.61/千词（代词 0.82 是量具错，主语脱落语）。★★ 台账报的两条「2002 年」是 **Project Gutenberg 发布年**，底本是 Richter 1883/1888 ⇒ PD 成立，已改正。**停在阶段 3（研究道）** |
