...
| #179 Kant | 65 | quick | 10 | 23 | **17 / 16** | ✅ passed |
| #181 Fröbel | 51 | quick | 4 | 23 | **16 / 16** | ✅ passed |
...
★★ 里面有一条**判分之前算出来的硬事实**：
四个 quick 档的人（Machiavelli／Rousseau／Kant／Fröbel），
门 +0.03 只有 **1.83–1.89 个 SE**——**低于 2 SE，「过门」与「等于零」分不开**；
四个 deep 档的是 **6.03 SE**，分得清。
⇒ **那四人最好的结果也只能写成「测不出差别」**，这句话写在判分之前，判完不许翻案。
