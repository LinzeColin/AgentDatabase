...
- **待用户裁定的条目**：**读 `registry/codex/persona-distiller/references/ledgers/_待用户裁定.md`**（三十五条，每条都带「你选一个，我就照做」的选项）。
  ...
  **1931 年时已满 19 岁的是 0 人**。㉜ 现在摆的三个选项都不改 `≤1930` 这条门槛本身，
  所以**它最多解锁 4 人，不是 75 人**。真正挡着那 71 人的是另一个问题
...
- **2026-08-10 又做了四人 + 三件判据**：
  ...
  - **#165 Shewhart 探测完成——★ 他与 Heinrich 不是一类，可以做**：首版 1931 差一年，
    但 **≤1930 已核实可免费全文 8 份、约 210 页**（BSTJ 六篇 1924–1930 + 1914 硕论 + 1922 PNAS）。
    **恰好 8 份 = quick 档 `min_sources` 下限，零余量。**
    报告在 `_corpora/_探测记录/165-shewhart-可得性探测.md`。
