...
| 4 | **Louis Brandeis #172** | **阶段 2 完成，过 quick 档**（一手 31／占比 0.8158／**道 5**／294 万词）。★★ **离 deep 最近**：一手与占比都已过 deep 的门，只卡总数 38<45 与道 5<6（缺 timeline）；补这两项都要放宽检索式，**而那正是同名门失效的那一步**。★ 开工前的同名门阻塞已解（14 候选原只裁定 1 个）。holdout 已密封 **4 条、全部来自 writings**（工具没抽空任何一道，四处缺口照实报）；声口按体裁分层——**≥1.0/千词的 12 份合计 86 万词**，技术短文接近 0。**阶段 3 完成**（6 条引文逐字全对、holdout 提及 0）。★★ 硬纪律：他的书**大量引用他人**，7 条第一人称候选里 **3 条是被引的第三方**（MacCormac／Fisher／Reusswig）——**每条引文回原文看前 700 字**。**下一步：阶段 4** |
