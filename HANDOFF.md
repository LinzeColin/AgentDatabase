...
- **#168 Hugo Grotius —— 语料已灌入，停在研究门，等裁定 ㊱**（政治法律师，1583–1645）。
  ...
  **19 份公有领域语料已灌入**（一手 0.7778 / 4 道 / 19 份全 ≤1930，
  ...
  - ★★★★ **卡点已登记为待裁定 ㊱**：`check_authorship` 是**现算**的、不读台账的
    `authorship_evidence`，而抓源方**逐份用眼睛读过题名页**。
    认不认「人核过的证据」**改的是全库这道门的含义**，不只这 6 条。
  - **不裁定也能走**（现算过）：去掉那 6 份 → train 12 / 一手 0.6667 / 道 3，**三道门仍全过**；
    **但 `expression` 整道归零，而那两份诗作是全批声口最密的一档（7.66/千词）**。
