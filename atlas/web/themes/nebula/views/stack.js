...
<div class="slab" style="padding:12px 12px 8px"><canvas class="viz" id="rings" style="border:0;background:none" role="img" aria-label="各应用的缓存命中率对照图。逐项明细见下方表格。"></canvas></div>
${drawer('摊开应用明细', table(
